...
emp1 = Employee("MAHIDHAR", "MORTHA", 500000, "IT")
emp2 = Employee("REVANTH", "JASTHI", 600000, "IT")
emp3 = Employee("KALYAN", "MARNEEDI", 100000, "HR")
emp4 = Employee("DEEPIKA", "IRINKI", 100000, "HR")
...
fulltime_employee2 = FulltimeEmployee("SANJANA", "MORTHA", 800000, "PRODUCTION", "Provident fund")
